...
watch(
  ...
  async (newQuery, oldQuery) => {
    ...
    if (newHasFilters) {
      const filterChanged = JSON.stringify(newQuery) !== JSON.stringify(oldQuery)
      if (filterChanged) {
  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <template v-if="hasQueryFilters">
        <div class="lg:hidden mb-6">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1">
              <BSelect
                v-model="filterState.sort.value"
                :options="sortOptions"
                size="sm"
              />
            </div>
        ...
        <div class="flex gap-6">
                ...
                <div v-if="filtersData.filters.value?.categories?.length" class="bg-white rounded-lg border border-gray-200 p-4">
                  ...
                  <div class="space-y-2">
                    <button
                      ...
                      :class="filterState.category.value === cat.slug
              ...
              <Transition name="fade" mode="out-in">
                <div v-if="filteredSubcategories.length > 0" class="bg-white rounded-lg border border-gray-200 p-4">
                  ...
                  <div class="space-y-1 max-h-60 overflow-y-auto">
                    ...
                    >
                      <BCheckbox
                        :model-value="isSubcategorySelected(sub.slug)"
                        :label="sub.name"
                        @update:model-value="toggleSubcategory(sub.slug)"
                      />
          ...
          <main class="flex-1 min-w-0">
            <div class="hidden lg:flex items-center justify-between bg-white rounded-lg border border-gray-200 p-4 mb-6">
            ...
            <div
              v-if="allProducts.length > 0 && productsData.total.value > 20 && !initialLoading"
              class="mt-4"
            >
          ...
          <Transition name="fade" mode="out-in">
            ...
            >
              ...
              >
                ...
                <h3 class="text-sm lg:text-base font-medium text-gray-700 text-center group-hover:text-green-700 transition-colors line-clamp-2">
                  {{ category.name }}
                </h3>

                <p
                  v-if="categoryStore.getSubcategories(category.id).length"
                  class="text-xs text-gray-400 text-center mt-1 lg:mt-2"
                >
    ...
    <Teleport to="body">
      ...
      <Transition name="slide">
        <div
          v-if="isFilterOpen"
          class="fixed inset-y-0 left-0 w-80 max-w-full bg-white z-50 flex flex-col lg:hidden shadow-2xl"
        >
